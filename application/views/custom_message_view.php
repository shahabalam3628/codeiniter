...
<em style="color:red;font-size:10px"><?php if(isset($uplod_error_message)){echo $uplod_error_message;} ?></em>
<em style="color:red;font-size:10px"><?php echo form_error('image'); ?></em>
    </div>
